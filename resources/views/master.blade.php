...
<body>
    ...
    <div id="lock-screen" class="z-[999999] opacity-95 duration-[1500ms] fixed top-0 left-0 w-screen h-screen bg-gray-900 flex items-center justify-center">
        <div class="p-8 w-96 text-white text-center">
            ...
            <div class="relative">
                ...
                <input type="password" id="input-pass" class="block p-2 ps-10 text-sm rounded-lg w-80 bg-gray-600 dark:bg-gray-700 dark:border-gray-600 placeholder-white dark:text-white" placeholder="Password" autocomplete="off" autofocus>
            </div>
                ...
                <div class="flex items-center lg:order-2">
                    ...
                    <div class="hidden z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 rounded-xl"
                        ...
                        <ul class="py-1 text-gray-700 dark:text-gray-300" aria-labelledby="dropdown">
                            ...
                            <li>
                                <a href="#" onClick="showLockScreen()"
                                    class="block py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-400 dark:hover:text-white">Lock
                                    Screen</a>
                            </li>
                        </ul>
                        <ul class="py-1 text-gray-700 dark:text-gray-300" aria-labelledby="dropdown">
